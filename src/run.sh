...
# for i in {1..10};
# do
# $BUILD_PATH/intersection -s $DATA_PATH/$DATA6 -t $DATA_PATH/$DATA7 -r -g >> output1.txt
...
# $BUILD_PATH/intersection_cpu -s $DATA_PATH/$DATA6 -t $DATA_PATH/$DATA7 -r >> output.txt
