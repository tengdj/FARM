...
int main(int argc, char** argv) {
	...
	vector<Ideal *> polygons = load_polygon_wkt("/home/qmh/data/wkt/valid_child_normal2.wkt");
    ...
    dump_polygons_to_file(polygons, "/home/qmh/data/idl/child_normal_float.idl");
    return 0;
}